...
func (p *ChannelException) Validate() error {
  return nil
}
// Attributes:
//  - Token
...
func (p *ChannelToken) Validate() error {
  return nil
}
// Attributes:
//  - ReturnUrl
...
func (p *WebLoginResponse) Validate() error {
  return nil
}
// Attributes:
//  - HookedFullUrl
...
func (p *WebLoginRequest) Validate() error {
  return nil
}
...
func (p *ChannelServiceClient) GetReturnUrlWithRequestTokenForAutoLogin(ctx context.Context, webLoginRequest *WebLoginRequest) (_r *WebLoginResponse, _err error) {
  var _args7 ChannelServiceGetReturnUrlWithRequestTokenForAutoLoginArgs
  _args7.WebLoginRequest = webLoginRequest
  var _result9 ChannelServiceGetReturnUrlWithRequestTokenForAutoLoginResult
  var _meta8 thrift.ResponseMeta
  _meta8, _err = p.Client_().Call(ctx, "getReturnUrlWithRequestTokenForAutoLogin", &_args7, &_result9)
...
func NewChannelServiceProcessor(handler ChannelService) *ChannelServiceProcessor {
  ...
  self11 := &ChannelServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self11.processorMap["issueChannelToken"] = &channelServiceProcessorIssueChannelToken{handler:handler}
  self11.processorMap["getReturnUrlWithRequestTokenForAutoLogin"] = &channelServiceProcessorGetReturnUrlWithRequestTokenForAutoLogin{handler:handler}
return self11
}
...
func (p *channelServiceProcessorIssueChannelToken) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.IssueChannelToken(ctx, args.ChannelId); err2 != nil {
    ...
    default:
      ...
      _exc14 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing issueChannelToken: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "issueChannelToken", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *channelServiceProcessorGetReturnUrlWithRequestTokenForAutoLogin) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.GetReturnUrlWithRequestTokenForAutoLogin(ctx, args.WebLoginRequest); err2 != nil {
    ...
    default:
      ...
      _exc16 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing getReturnUrlWithRequestTokenForAutoLogin: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "getReturnUrlWithRequestTokenForAutoLogin", thrift.EXCEPTION, seqId); err2 != nil {
