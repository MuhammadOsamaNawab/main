...
func (p *BuddyList) Validate() error {
  return nil
}
// Attributes:
//  - Mid
...
func (p *BuddyDetail) Validate() error {
  return nil
}
...
func (p *BuddyServiceClient) GetBuddyDetail(ctx context.Context, buddyMid string) (_r *BuddyDetail, _err error) {
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "getBuddyDetail failed: unknown result")
}
...
func NewBuddyServiceProcessor(handler BuddyService) *BuddyServiceProcessor {
  ...
  self14 := &BuddyServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self14.processorMap["getPopularBuddyLists"] = &buddyServiceProcessorGetPopularBuddyLists{handler:handler}
  self14.processorMap["getBuddyContacts"] = &buddyServiceProcessorGetBuddyContacts{handler:handler}
  self14.processorMap["getBuddyDetail"] = &buddyServiceProcessorGetBuddyDetail{handler:handler}
return self14
}
...
func (p *buddyServiceProcessorGetPopularBuddyLists) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.GetPopularBuddyLists(ctx, args.Language, args.Country); err2 != nil {
    ...
    default:
      ...
      _exc17 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing getPopularBuddyLists: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "getPopularBuddyLists", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *buddyServiceProcessorGetBuddyContacts) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.GetBuddyContacts(ctx, args.Language, args.Country, args.Classification, args.FromIndex, args.Count); err2 != nil {
    ...
    default:
      ...
      _exc19 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing getBuddyContacts: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "getBuddyContacts", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *buddyServiceProcessorGetBuddyDetail) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.GetBuddyDetail(ctx, args.BuddyMid); err2 != nil {
    ...
    default:
      ...
      _exc21 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing getBuddyDetail: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "getBuddyDetail", thrift.EXCEPTION, seqId); err2 != nil {
