...
func (p *SecondaryQrCodeException) Validate() error {
  return nil
}
// Attributes:
//  - AuthSessionId
...
func (p *CreateQrSessionResponse) Validate() error {
  return nil
}
...
func (p *CreateQrSessionRequest) Validate() error {
  return nil
}
// Attributes:
//  - CallbackUrl
...
func (p *CreateQrCodeResponse) Validate() error {
  return nil
}
// Attributes:
//  - AuthSessionId
...
func (p *CreateQrCodeRequest) Validate() error {
  return nil
}
// Attributes:
//  - PinCode
...
func (p *CreatePinCodeResponse) Validate() error {
  return nil
}
// Attributes:
//  - AuthSessionId
...
func (p *CreatePinCodeRequest) Validate() error {
  return nil
}
...
func (p *VerifyCertificateResponse) Validate() error {
  return nil
}
// Attributes:
//  - AuthSessionId
...
func (p *VerifyCertificateRequest) Validate() error {
  return nil
}
// Attributes:
//  - Certificate
...
func (p *QrCodeLoginResponse) Validate() error {
  return nil
}
// Attributes:
//  - AuthSessionId
...
func (p *QrCodeLoginRequest) Validate() error {
  return nil
}
...
func (p *SecondaryQrCodeLoginServiceClient) CreateQrCode(ctx context.Context, request *CreateQrCodeRequest) (_r *CreateQrCodeResponse, _err error) {
  var _args7 SecondaryQrCodeLoginServiceCreateQrCodeArgs
  _args7.Request = request
  var _result9 SecondaryQrCodeLoginServiceCreateQrCodeResult
  var _meta8 thrift.ResponseMeta
  _meta8, _err = p.Client_().Call(ctx, "createQrCode", &_args7, &_result9)
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "createQrCode failed: unknown result")
}
...
func (p *SecondaryQrCodeLoginServiceClient) CreatePinCode(ctx context.Context, request *CreatePinCodeRequest) (_r *CreatePinCodeResponse, _err error) {
  var _args11 SecondaryQrCodeLoginServiceCreatePinCodeArgs
  _args11.Request = request
  var _result13 SecondaryQrCodeLoginServiceCreatePinCodeResult
  var _meta12 thrift.ResponseMeta
  _meta12, _err = p.Client_().Call(ctx, "createPinCode", &_args11, &_result13)
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "createPinCode failed: unknown result")
}
...
func (p *SecondaryQrCodeLoginServiceClient) VerifyCertificate(ctx context.Context, request *VerifyCertificateRequest) (_r *VerifyCertificateResponse, _err error) {
  var _args15 SecondaryQrCodeLoginServiceVerifyCertificateArgs
  _args15.Request = request
  var _result17 SecondaryQrCodeLoginServiceVerifyCertificateResult
  var _meta16 thrift.ResponseMeta
  _meta16, _err = p.Client_().Call(ctx, "verifyCertificate", &_args15, &_result17)
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "verifyCertificate failed: unknown result")
}
...
func (p *SecondaryQrCodeLoginServiceClient) QrCodeLogin(ctx context.Context, request *QrCodeLoginRequest) (_r *QrCodeLoginResponse, _err error) {
  var _args19 SecondaryQrCodeLoginServiceQrCodeLoginArgs
  _args19.Request = request
  var _result21 SecondaryQrCodeLoginServiceQrCodeLoginResult
  var _meta20 thrift.ResponseMeta
  _meta20, _err = p.Client_().Call(ctx, "qrCodeLogin", &_args19, &_result21)
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "qrCodeLogin failed: unknown result")
}
...
func NewSecondaryQrCodeLoginServiceProcessor(handler SecondaryQrCodeLoginService) *SecondaryQrCodeLoginServiceProcessor {
  ...
  self23 := &SecondaryQrCodeLoginServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self23.processorMap["createSession"] = &secondaryQrCodeLoginServiceProcessorCreateSession{handler:handler}
  self23.processorMap["createQrCode"] = &secondaryQrCodeLoginServiceProcessorCreateQrCode{handler:handler}
  self23.processorMap["createPinCode"] = &secondaryQrCodeLoginServiceProcessorCreatePinCode{handler:handler}
  self23.processorMap["verifyCertificate"] = &secondaryQrCodeLoginServiceProcessorVerifyCertificate{handler:handler}
  self23.processorMap["qrCodeLogin"] = &secondaryQrCodeLoginServiceProcessorQrCodeLogin{handler:handler}
return self23
}
...
func (p *secondaryQrCodeLoginServiceProcessorCreateSession) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.CreateSession(ctx, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc26 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing createSession: " + err2.Error())
...
func (p *secondaryQrCodeLoginServiceProcessorCreateQrCode) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.CreateQrCode(ctx, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc28 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing createQrCode: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "createQrCode", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *secondaryQrCodeLoginServiceProcessorCreatePinCode) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.CreatePinCode(ctx, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc30 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing createPinCode: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "createPinCode", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *secondaryQrCodeLoginServiceProcessorVerifyCertificate) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.VerifyCertificate(ctx, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc32 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing verifyCertificate: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "verifyCertificate", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *secondaryQrCodeLoginServiceProcessorQrCodeLogin) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.QrCodeLogin(ctx, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc34 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing qrCodeLogin: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "qrCodeLogin", thrift.EXCEPTION, seqId); err2 != nil {
