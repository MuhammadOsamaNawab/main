...
func (p *StickerIdRange) Validate() error {
  return nil
}
// Attributes:
//  - ProductId
...
func (p *ProductSimple) Validate() error {
  return nil
}
// Attributes:
//  - HasNext
...
func (p *ProductSimpleList) Validate() error {
  return nil
}
...
func (p *ShopServiceClient) GetActivePurchaseVersions(ctx context.Context, start int64, size int32, language string, country string) (_r *ProductSimpleList, _err error) {
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "getActivePurchaseVersions failed: unknown result")
}
...
func NewShopServiceProcessor(handler ShopService) *ShopServiceProcessor {
  ...
  self11 := &ShopServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self11.processorMap["notifyDownloaded"] = &shopServiceProcessorNotifyDownloaded{handler:handler}
  self11.processorMap["getActivePurchaseVersions"] = &shopServiceProcessorGetActivePurchaseVersions{handler:handler}
return self11
}
...
func (p *shopServiceProcessorNotifyDownloaded) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.NotifyDownloaded(ctx, args.PackageId, args.Language); err2 != nil {
    ...
    default:
      ...
      _exc14 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing notifyDownloaded: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "notifyDownloaded", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *shopServiceProcessorGetActivePurchaseVersions) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.GetActivePurchaseVersions(ctx, args.Start, args.Size, args.Language, args.Country); err2 != nil {
    ...
    default:
      ...
      _exc16 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing getActivePurchaseVersions: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "getActivePurchaseVersions", thrift.EXCEPTION, seqId); err2 != nil {
