...
func (p *CallRoute) Validate() error {
  return nil
}
// Attributes:
//  - VoipAddress
...
func (p *GroupCallRoute) Validate() error {
  return nil
}
// Attributes:
//  - Online
...
func (p *GroupCall) Validate() error {
  return nil
}
// Attributes:
//  - Port
...
func (p *CallHost) Validate() error {
  return nil
}
...
func (p *CallServiceClient) AcquireCallRoute(ctx context.Context, to string, callType FreeCallType, fromEnvInfo map[string]string) (_r *CallRoute, _err error) {
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "acquireCallRoute failed: unknown result")
}
...
func (p *CallServiceClient) AcquireGroupCallRoute(ctx context.Context, chatMid string, mediaType GroupCallMediaType, isInitialHost bool, capabilities []string) (_r *GroupCallRoute, _err error) {
  var _args8 CallServiceAcquireGroupCallRouteArgs
  _args8.ChatMid = chatMid
  _args8.MediaType = mediaType
  _args8.IsInitialHost = isInitialHost
  _args8.Capabilities = capabilities
  var _result10 CallServiceAcquireGroupCallRouteResult
  var _meta9 thrift.ResponseMeta
  _meta9, _err = p.Client_().Call(ctx, "acquireGroupCallRoute", &_args8, &_result10)
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "acquireGroupCallRoute failed: unknown result")
}

// Parameters:
//  - ChatMid
func (p *CallServiceClient) GetGroupCall(ctx context.Context, chatMid string) (_r *GroupCall, _err error) {
  var _args12 CallServiceGetGroupCallArgs
  _args12.ChatMid = chatMid
  var _result14 CallServiceGetGroupCallResult
  var _meta13 thrift.ResponseMeta
  _meta13, _err = p.Client_().Call(ctx, "getGroupCall", &_args12, &_result14)
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "getGroupCall failed: unknown result")
}
...
func NewCallServiceProcessor(handler CallService) *CallServiceProcessor {
  ...
  self16 := &CallServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self16.processorMap["acquireCallRoute"] = &callServiceProcessorAcquireCallRoute{handler:handler}
  self16.processorMap["acquireGroupCallRoute"] = &callServiceProcessorAcquireGroupCallRoute{handler:handler}
  self16.processorMap["getGroupCall"] = &callServiceProcessorGetGroupCall{handler:handler}
return self16
}
...
func (p *callServiceProcessorAcquireCallRoute) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.AcquireCallRoute(ctx, args.To, args.CallType, args.FromEnvInfo); err2 != nil {
    ...
    default:
      ...
      _exc19 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing acquireCallRoute: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "acquireCallRoute", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *callServiceProcessorAcquireGroupCallRoute) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.AcquireGroupCallRoute(ctx, args.ChatMid, args.MediaType, args.IsInitialHost, args.Capabilities); err2 != nil {
    ...
    default:
      ...
      _exc21 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing acquireGroupCallRoute: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "acquireGroupCallRoute", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *callServiceProcessorGetGroupCall) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.GetGroupCall(ctx, args.ChatMid); err2 != nil {
    ...
    default:
      ...
      _exc23 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing getGroupCall: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "getGroupCall", thrift.EXCEPTION, seqId); err2 != nil {
...
var _elem26 string
    ...
    p.Capabilities = append(p.Capabilities, _elem26)
  }
  if err := iprot.ReadListEnd(ctx); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
