...
func (p *TokenIssueResult_) Validate() error {
  return nil
}
// Attributes:
//  - AuthToken
...
func (p *AuthSessionRequest) Validate() error {
  return nil
}
// Attributes:
//  - MetaData
...
func (p *IdentityCredentialResponse) Validate() error {
  return nil
}
// Attributes:
//  - MetaData
...
func (p *IdentifierConfirmationRequest) Validate() error {
  return nil
}
// Attributes:
//  - MetaData
...
func (p *IdentityCredentialRequest) Validate() error {
  return nil
}
// Attributes:
//  - URI
...
func (p *SecurityCenterResult_) Validate() error {
  return nil
}
...
func (p *AuthServiceClient) LoginZ(ctx context.Context, loginRequest *LoginRequest) (_r *LoginResult_, _err error) {
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "loginZ failed: unknown result")
}
...
func (p *AuthServiceClient) ConfirmE2EELogin(ctx context.Context, verifier string, deviceSecret string) (_r string, _err error) {
  var _args16 AuthServiceConfirmE2EELoginArgs
  _args16.Verifier = verifier
  _args16.DeviceSecret = deviceSecret
  var _result18 AuthServiceConfirmE2EELoginResult
  var _meta17 thrift.ResponseMeta
  _meta17, _err = p.Client_().Call(ctx, "confirmE2EELogin", &_args16, &_result18)
...
func (p *AuthServiceClient) RespondE2EELoginRequest(ctx context.Context, verifier string, publicKey *talkservice.E2EEPublicKey, encryptedKeyChain string, hashKeyChain string, errorCode talkservice.ErrorCode) (_err error) {
  var _args19 AuthServiceRespondE2EELoginRequestArgs
  _args19.Verifier = verifier
  _args19.PublicKey = publicKey
  _args19.EncryptedKeyChain = encryptedKeyChain
  _args19.HashKeyChain = hashKeyChain
  _args19.ErrorCode = errorCode
  var _result21 AuthServiceRespondE2EELoginRequestResult
  var _meta20 thrift.ResponseMeta
  _meta20, _err = p.Client_().Call(ctx, "respondE2EELoginRequest", &_args19, &_result21)
...
func (p *AuthServiceClient) OpenAuthSession(ctx context.Context, request *AuthSessionRequest) (_r string, _err error) {
  var _args22 AuthServiceOpenAuthSessionArgs
  _args22.Request = request
  var _result24 AuthServiceOpenAuthSessionResult
  var _meta23 thrift.ResponseMeta
  _meta23, _err = p.Client_().Call(ctx, "openAuthSession", &_args22, &_result24)
...
func (p *AuthServiceClient) UpdatePassword(ctx context.Context, authSessionId string, request *IdentityCredentialRequest) (_r *IdentityCredentialResponse, _err error) {
  var _args25 AuthServiceUpdatePasswordArgs
  _args25.AuthSessionId = authSessionId
  _args25.Request = request
  var _result27 AuthServiceUpdatePasswordResult
  var _meta26 thrift.ResponseMeta
  _meta26, _err = p.Client_().Call(ctx, "updatePassword", &_args25, &_result27)
...
func (p *AuthServiceClient) LogoutZ(ctx context.Context) (_err error) {
  var _args29 AuthServiceLogoutZArgs
  var _result31 AuthServiceLogoutZResult
  var _meta30 thrift.ResponseMeta
  _meta30, _err = p.Client_().Call(ctx, "logoutZ", &_args29, &_result31)
...
func (p *AuthServiceClient) VerifyQrcodeWithE2EE(ctx context.Context, verifier string, pinCode string, errorCode talkservice.ErrorCode, publicKey *talkservice.E2EEPublicKey, encryptedKeyChain string, hashKeyChain string) (_r string, _err error) {
  var _args32 AuthServiceVerifyQrcodeWithE2EEArgs
  _args32.Verifier = verifier
  _args32.PinCode = pinCode
  _args32.ErrorCode = errorCode
  _args32.PublicKey = publicKey
  _args32.EncryptedKeyChain = encryptedKeyChain
  _args32.HashKeyChain = hashKeyChain
  var _result34 AuthServiceVerifyQrcodeWithE2EEResult
  var _meta33 thrift.ResponseMeta
  _meta33, _err = p.Client_().Call(ctx, "verifyQrcodeWithE2EE", &_args32, &_result34)
...
func (p *AuthServiceClient) GetAuthRSAKey(ctx context.Context, authSessionId string, identityProvider talkservice.IdentityProvider) (_r *talkservice.RSAKey, _err error) {
  var _args35 AuthServiceGetAuthRSAKeyArgs
  _args35.AuthSessionId = authSessionId
  _args35.IdentityProvider = identityProvider
  var _result37 AuthServiceGetAuthRSAKeyResult
  var _meta36 thrift.ResponseMeta
  _meta36, _err = p.Client_().Call(ctx, "getAuthRSAKey", &_args35, &_result37)
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "getAuthRSAKey failed: unknown result")
}
...
func (p *AuthServiceClient) IssueTokenForAccountMigrationSettings(ctx context.Context, enforce bool) (_r *SecurityCenterResult_, _err error) {
  var _args39 AuthServiceIssueTokenForAccountMigrationSettingsArgs
  _args39.Enforce = enforce
  var _result41 AuthServiceIssueTokenForAccountMigrationSettingsResult
  var _meta40 thrift.ResponseMeta
  _meta40, _err = p.Client_().Call(ctx, "issueTokenForAccountMigrationSettings", &_args39, &_result41)
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "issueTokenForAccountMigrationSettings failed: unknown result")
}
...
func (p *AuthServiceClient) SetPassword(ctx context.Context, authSessionId string, encryptedPassword *EncryptedPassword) (_r *SetPasswordResponse, _err error) {
  var _args43 AuthServiceSetPasswordArgs
  _args43.AuthSessionId = authSessionId
  _args43.EncryptedPassword = encryptedPassword
  var _result45 AuthServiceSetPasswordResult
...
func (p *AuthServiceClient) ConfirmIdentifier(ctx context.Context, authSessionId string, request *IdentityCredentialRequest) (_r *IdentityCredentialResponse, _err error) {
  var _args47 AuthServiceConfirmIdentifierArgs
  _args47.AuthSessionId = authSessionId
  _args47.Request = request
  var _result49 AuthServiceConfirmIdentifierResult
  var _meta48 thrift.ResponseMeta
  _meta48, _err = p.Client_().Call(ctx, "confirmIdentifier", &_args47, &_result49)
  ...
  case _result49.E!= nil:
    return _r, _result49.E
  }

  if _ret50 := _result49.GetSuccess(); _ret50 != nil {
    return _ret50, nil
  }
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "confirmIdentifier failed: unknown result")
}
...
func (p *AuthServiceClient) SetIdentifier(ctx context.Context, authSessionId string, request *IdentityCredentialRequest) (_r *IdentityCredentialResponse, _err error) {
  var _args51 AuthServiceSetIdentifierArgs
  _args51.AuthSessionId = authSessionId
  _args51.Request = request
  var _result53 AuthServiceSetIdentifierResult
  var _meta52 thrift.ResponseMeta
  _meta52, _err = p.Client_().Call(ctx, "setIdentifier", &_args51, &_result53)
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "setIdentifier failed: unknown result")
}
...
func (p *AuthServiceClient) SetIdentifierAndPassword(ctx context.Context, authSessionId string, request *IdentityCredentialRequest) (_r *IdentityCredentialResponse, _err error) {
  var _args55 AuthServiceSetIdentifierAndPasswordArgs
  _args55.AuthSessionId = authSessionId
  _args55.Request = request
  var _result57 AuthServiceSetIdentifierAndPasswordResult
  var _meta56 thrift.ResponseMeta
  _meta56, _err = p.Client_().Call(ctx, "setIdentifierAndPassword", &_args55, &_result57)
  ...
  case _result57.E!= nil:
    return _r, _result57.E
  }

  if _ret58 := _result57.GetSuccess(); _ret58 != nil {
    return _ret58, nil
  }
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "setIdentifierAndPassword failed: unknown result")
}
...
func (p *AuthServiceClient) UpdateIdentifier(ctx context.Context, authSessionId string, request *IdentityCredentialRequest) (_r *IdentityCredentialResponse, _err error) {
  var _args59 AuthServiceUpdateIdentifierArgs
  _args59.AuthSessionId = authSessionId
  _args59.Request = request
  var _result61 AuthServiceUpdateIdentifierResult
  var _meta60 thrift.ResponseMeta
  _meta60, _err = p.Client_().Call(ctx, "updateIdentifier", &_args59, &_result61)
  ...
  case _result61.E!= nil:
    return _r, _result61.E
  }

  if _ret62 := _result61.GetSuccess(); _ret62 != nil {
    return _ret62, nil
  }
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "updateIdentifier failed: unknown result")
}
...
func (p *AuthServiceClient) ResendIdentifierConfirmation(ctx context.Context, authSessionId string, request *IdentityCredentialRequest) (_r *IdentityCredentialResponse, _err error) {
  var _args63 AuthServiceResendIdentifierConfirmationArgs
  _args63.AuthSessionId = authSessionId
  _args63.Request = request
  var _result65 AuthServiceResendIdentifierConfirmationResult
  var _meta64 thrift.ResponseMeta
  _meta64, _err = p.Client_().Call(ctx, "resendIdentifierConfirmation", &_args63, &_result65)
  ...
  case _result65.E!= nil:
    return _r, _result65.E
  }

  if _ret66 := _result65.GetSuccess(); _ret66 != nil {
    return _ret66, nil
  }
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "resendIdentifierConfirmation failed: unknown result")
}
...
func (p *AuthServiceClient) RemoveIdentifier(ctx context.Context, authSessionId string, request *IdentityCredentialRequest) (_r *IdentityCredentialResponse, _err error) {
  var _args67 AuthServiceRemoveIdentifierArgs
  _args67.AuthSessionId = authSessionId
  _args67.Request = request
  var _result69 AuthServiceRemoveIdentifierResult
  var _meta68 thrift.ResponseMeta
  _meta68, _err = p.Client_().Call(ctx, "removeIdentifier", &_args67, &_result69)
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "removeIdentifier failed: unknown result")
}
...
func NewAuthServiceProcessor(handler AuthService) *AuthServiceProcessor {
  ...
  self71 := &AuthServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self71.processorMap["loginZ"] = &authServiceProcessorLoginZ{handler:handler}
  self71.processorMap["confirmE2EELogin"] = &authServiceProcessorConfirmE2EELogin{handler:handler}
  self71.processorMap["respondE2EELoginRequest"] = &authServiceProcessorRespondE2EELoginRequest{handler:handler}
  self71.processorMap["openAuthSession"] = &authServiceProcessorOpenAuthSession{handler:handler}
  self71.processorMap["updatePassword"] = &authServiceProcessorUpdatePassword{handler:handler}
  self71.processorMap["logoutZ"] = &authServiceProcessorLogoutZ{handler:handler}
  self71.processorMap["verifyQrcodeWithE2EE"] = &authServiceProcessorVerifyQrcodeWithE2EE{handler:handler}
  self71.processorMap["getAuthRSAKey"] = &authServiceProcessorGetAuthRSAKey{handler:handler}
  self71.processorMap["issueTokenForAccountMigrationSettings"] = &authServiceProcessorIssueTokenForAccountMigrationSettings{handler:handler}
  self71.processorMap["setPassword"] = &authServiceProcessorSetPassword{handler:handler}
  self71.processorMap["confirmIdentifier"] = &authServiceProcessorConfirmIdentifier{handler:handler}
  self71.processorMap["setIdentifier"] = &authServiceProcessorSetIdentifier{handler:handler}
  self71.processorMap["setIdentifierAndPassword"] = &authServiceProcessorSetIdentifierAndPassword{handler:handler}
  self71.processorMap["updateIdentifier"] = &authServiceProcessorUpdateIdentifier{handler:handler}
  self71.processorMap["resendIdentifierConfirmation"] = &authServiceProcessorResendIdentifierConfirmation{handler:handler}
  self71.processorMap["removeIdentifier"] = &authServiceProcessorRemoveIdentifier{handler:handler}
return self71
}
...
func (p *authServiceProcessorLoginZ) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.LoginZ(ctx, args.LoginRequest); err2 != nil {
    ...
    default:
      ...
      _exc74 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing loginZ: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "loginZ", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorConfirmE2EELogin) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.ConfirmE2EELogin(ctx, args.Verifier, args.DeviceSecret); err2 != nil {
    ...
    default:
      ...
      _exc76 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing confirmE2EELogin: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "confirmE2EELogin", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorRespondE2EELoginRequest) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if err2 := p.handler.RespondE2EELoginRequest(ctx, args.Verifier, args.PublicKey, args.EncryptedKeyChain, args.HashKeyChain, args.ErrorCode); err2 != nil {
    ...
    default:
      ...
      _exc78 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing respondE2EELoginRequest: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "respondE2EELoginRequest", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorOpenAuthSession) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.OpenAuthSession(ctx, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc80 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing openAuthSession: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "openAuthSession", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorUpdatePassword) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.UpdatePassword(ctx, args.AuthSessionId, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc82 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing updatePassword: " + err2.Error())
...
func (p *authServiceProcessorLogoutZ) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if err2 := p.handler.LogoutZ(ctx); err2 != nil {
    ...
    default:
      ...
      _exc84 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing logoutZ: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "logoutZ", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorVerifyQrcodeWithE2EE) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.VerifyQrcodeWithE2EE(ctx, args.Verifier, args.PinCode, args.ErrorCode, args.PublicKey, args.EncryptedKeyChain, args.HashKeyChain); err2 != nil {
    ...
    default:
      ...
      _exc86 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing verifyQrcodeWithE2EE: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "verifyQrcodeWithE2EE", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorGetAuthRSAKey) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.GetAuthRSAKey(ctx, args.AuthSessionId, args.IdentityProvider); err2 != nil {
    ...
    default:
      ...
      _exc88 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing getAuthRSAKey: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "getAuthRSAKey", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorIssueTokenForAccountMigrationSettings) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.IssueTokenForAccountMigrationSettings(ctx, args.Enforce); err2 != nil {
    ...
    default:
      ...
      _exc90 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing issueTokenForAccountMigrationSettings: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "issueTokenForAccountMigrationSettings", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorSetPassword) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.SetPassword(ctx, args.AuthSessionId, args.EncryptedPassword); err2 != nil {
    ...
    default:
      ...
      _exc92 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing setPassword: " + err2.Error())
...
func (p *authServiceProcessorConfirmIdentifier) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.ConfirmIdentifier(ctx, args.AuthSessionId, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc94 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing confirmIdentifier: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "confirmIdentifier", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorSetIdentifier) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.SetIdentifier(ctx, args.AuthSessionId, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc96 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing setIdentifier: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "setIdentifier", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorSetIdentifierAndPassword) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.SetIdentifierAndPassword(ctx, args.AuthSessionId, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc98 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing setIdentifierAndPassword: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "setIdentifierAndPassword", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorUpdateIdentifier) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.UpdateIdentifier(ctx, args.AuthSessionId, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc100 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing updateIdentifier: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "updateIdentifier", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorResendIdentifierConfirmation) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.ResendIdentifierConfirmation(ctx, args.AuthSessionId, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc102 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing resendIdentifierConfirmation: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "resendIdentifierConfirmation", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *authServiceProcessorRemoveIdentifier) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.RemoveIdentifier(ctx, args.AuthSessionId, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc104 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing removeIdentifier: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "removeIdentifier", thrift.EXCEPTION, seqId); err2 != nil {
