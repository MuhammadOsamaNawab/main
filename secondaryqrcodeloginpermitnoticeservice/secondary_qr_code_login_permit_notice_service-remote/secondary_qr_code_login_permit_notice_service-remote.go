...
var _ = secondaryqrcodeloginpermitnoticeservice.GoUnusedProtection__
...
func main() {
  ...
  client := secondaryqrcodeloginpermitnoticeservice.NewSecondaryQrCodeLoginPermitNoticeServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "checkQrCodeVerified":
    ...
    argvalue0 := secondaryqrcodeloginpermitnoticeservice.NewCheckQrCodeVerifiedRequest()
  ...
  case "checkPinCodeVerified":
    ...
    argvalue0 := secondaryqrcodeloginpermitnoticeservice.NewCheckPinCodeVerifiedRequest()
