...
func (p *CheckQrCodeVerifiedResponse) Validate() error {
  return nil
}
// Attributes:
//  - AuthSessionId
...
func (p *CheckQrCodeVerifiedRequest) Validate() error {
  return nil
}
...
func (p *CheckPinCodeVerifiedResponse) Validate() error {
  return nil
}
// Attributes:
//  - AuthSessionId
...
func (p *CheckPinCodeVerifiedRequest) Validate() error {
  return nil
}
...
func (p *SecondaryQrCodeLoginPermitNoticeServiceClient) CheckQrCodeVerified(ctx context.Context, request *CheckQrCodeVerifiedRequest) (_r *CheckQrCodeVerifiedResponse, _err error) {
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "checkQrCodeVerified failed: unknown result")
}
...
func (p *SecondaryQrCodeLoginPermitNoticeServiceClient) CheckPinCodeVerified(ctx context.Context, request *CheckPinCodeVerifiedRequest) (_r *CheckPinCodeVerifiedResponse, _err error) {
  var _args4 SecondaryQrCodeLoginPermitNoticeServiceCheckPinCodeVerifiedArgs
  _args4.Request = request
  var _result6 SecondaryQrCodeLoginPermitNoticeServiceCheckPinCodeVerifiedResult
  var _meta5 thrift.ResponseMeta
  _meta5, _err = p.Client_().Call(ctx, "checkPinCodeVerified", &_args4, &_result6)
  ...
  return nil, thrift.NewTApplicationException(thrift.MISSING_RESULT, "checkPinCodeVerified failed: unknown result")
}
...
func NewSecondaryQrCodeLoginPermitNoticeServiceProcessor(handler SecondaryQrCodeLoginPermitNoticeService) *SecondaryQrCodeLoginPermitNoticeServiceProcessor {
  ...
  self8 := &SecondaryQrCodeLoginPermitNoticeServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self8.processorMap["checkQrCodeVerified"] = &secondaryQrCodeLoginPermitNoticeServiceProcessorCheckQrCodeVerified{handler:handler}
  self8.processorMap["checkPinCodeVerified"] = &secondaryQrCodeLoginPermitNoticeServiceProcessorCheckPinCodeVerified{handler:handler}
return self8
}
...
func (p *secondaryQrCodeLoginPermitNoticeServiceProcessorCheckQrCodeVerified) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.CheckQrCodeVerified(ctx, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc11 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing checkQrCodeVerified: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "checkQrCodeVerified", thrift.EXCEPTION, seqId); err2 != nil {
...
func (p *secondaryQrCodeLoginPermitNoticeServiceProcessorCheckPinCodeVerified) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if retval, err2 := p.handler.CheckPinCodeVerified(ctx, args.Request); err2 != nil {
    ...
    default:
      ...
      _exc13 := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing checkPinCodeVerified: " + err2.Error())
      if err2 := oprot.WriteMessageBegin(ctx, "checkPinCodeVerified", thrift.EXCEPTION, seqId); err2 != nil {
